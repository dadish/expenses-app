...
const route = {
  ...
  config: {
    ...
    validate: {
      query: {
        userEmail: Joi.string().optional().description('String that is present in user`s email.'),
        ...
        amountMax: Joi.number().optional().description('The maximum amount spent. In Cents.'),
        amountMin: Joi.number().optional().description('The minimum amount spent. In Cents.'),
